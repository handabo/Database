...
-- (4)查询所有80后学生的姓名、性别(显示成'女')和出生日期(筛选)
...
-- (13)查询1111课程的平均分/最低分/最高分/选课人数/考试人数
